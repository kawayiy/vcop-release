...
if __name__ == '__main__':
    ...
    if args.mode == 'train':  ########### Train #############
        ...
        # train_dataset = CSLDailyVCOPDataset('data/mini_CSL_Daily', args.cl, args.it, args.tl, True, train_transforms)
        # val_dataset = CSLDailyVCOPDataset('data/mini_CSL_Daily', args.cl, args.it, args.tl, False, train_transforms)

        train_dataset = CSLDailyVCOPDataset('/projects/u5ia/pxl416/data/CSL-Daily', args.cl, args.it, args.tl, True, train_transforms)
        val_dataset = CSLDailyVCOPDataset('/projects/u5ia/pxl416/data/CSL-Daily', args.cl, args.it, args.tl, False, train_transforms)
